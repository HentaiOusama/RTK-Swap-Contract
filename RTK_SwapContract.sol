...
contract RTK_SwapContract {
    ...
    */
    ...
    constructor(address RTK, address RTKL2, address RTKL3, address RTKL4, address RTKL5, address AMMO) public {
        ...
        _RTKLX_InitialSupply[1] = ERC20(RTKL2).totalSupply();
        _RTKLX_InitialSupply[2] = ERC20(RTKL3).totalSupply();
        _RTKLX_InitialSupply[3] = ERC20(RTKL4).totalSupply();
        _RTKLX_InitialSupply[4] = ERC20(RTKL5).totalSupply();
